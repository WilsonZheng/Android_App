...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView tvFullname = (TextView) mNavigationView.findViewById(R.id.tv_full_name);
        TextView tvUsername = (TextView) mNavigationView.findViewById(R.id.tv_username);

        //Get user profile from remote server or local storage
        tvFullname.setText("Kai");
        tvUsername.setText("kai.zhang@centralstationsoftware.co.nz");
